...
try {
  ...
  await page.evaluate(async () => {
    const { openAssetStudio, closeAssetStudio } = await import('./asset-studio.js?v=20260917-20');
    const { MEMO_TEMPLATE } = await import('./memo-template.js?v=20260917-20');
    const { MEMO_EXAMPLE } = await import('./memo-example.js?v=20260917-20');
