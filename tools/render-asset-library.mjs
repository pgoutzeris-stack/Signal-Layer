...
const BEISPIEL = {
  ...
  S3: { title: "Das Markenhaus auf einen Blick", subtitle: "Dach, Säulen und Fundament einer Positionierung.", slot_a: "Markenversprechen", slot_b: "Relevanz", slot_center: "Beweise", steps: [{ title: "Haltung", text: "klare Position" }, { title: "Codes", text: "gleiche Zeichen" }, { title: "Erlebnis", text: "eingelöst" }], takeaway: "Ohne Fundament trägt kein Dach." },
  ...
  T1: { title: "Markenbekanntheit über sieben Quartale", subtitle: "Konsistenter Auftritt, gleiches Budget.", stats: [{ value: "41", label: "Q1" }, { value: "48", label: "Q2" }, { value: "57", label: "Q3" }, { value: "63", label: "Q4" }, { value: "68", label: "Q5" }, { value: "74", label: "Q6" }, { value: "79", label: "Q7" }], takeaway: "Wirkung kumuliert, wenn nichts wechselt." },
  ...
  T4: { title: "Wo Marketingteams Wirkung sehen", subtitle: "Vier Anwendungsfälle im Vergleich.", stats: [{ value: "68 %", label: "Markenauftritt" }, { value: "54 %", label: "Content" }, { value: "47 %", label: "Kampagnen" }, { value: "39 %", label: "Vertriebsunterlagen" }, { value: "31 %", label: "Messeauftritt" }], takeaway: "Der Auftritt zahlt am breitesten ein." },
