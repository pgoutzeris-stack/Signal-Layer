  ...
  const stages = [
    ...
    },
    {
      ...
      tabs: [
        ...
        </div><div class="pipeline-locked-grid">${lockedRule("Score ist keine Konfidenz", "Er misst den Nutzwert für Marketing-Assets beziehungsweise konkrete Sales-Opportunities.")}${lockedRule("Kein drittes KI-Modell", "Die Komponenten entstehen im Hauptaufruf; Review nur nach bestehender Regel.")}${lockedRule("Separate Marketing-Evidenz", "Fest im Prompt und Servercode; Unternehmensnennung genügt nie.")}${lockedRule("Reine CEO-/CMO-Ernennung ablehnen", "Fest im Code; nur mit strategischem Trigger weiter.")}</div>` },
